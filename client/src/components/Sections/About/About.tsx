        ...
        <div className="container">
            <div className="About__wrapper">
                ...
                <div className="About__content">
                    ...
                    <div className="About__description">Компания "***" обладает современными производственными мощностями, которые позволяют осуществлять высококачественную сборку низковольтных комплектных устройств (НКУ) любой степени сложности в кратчайшие сроки. <span>Среди нашей продукции находятся:</span></div>
